...
- Send DAI using meta-transactions enabled by Infura ITX.
- Send DAI with a delay by first supplying it to Compound Protocol. The interest generated from Compound will compensate for the gas.
